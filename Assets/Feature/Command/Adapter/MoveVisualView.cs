...
#if UNITY_EDITOR
            if (_moveStartPoint == null) throw new NullReferenceException();
            if (_moveEndPoint == null) throw new NullReferenceException();
            if (_moveLinker == null) throw new NullReferenceException();
            if (_canvassScaler == null)  throw new NullReferenceException("Script is not attached to a Canvas");
#endif
            Hide();
        }
