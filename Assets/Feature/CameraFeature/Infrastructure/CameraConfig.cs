...
namespace Feature.CameraFeature.Infrastructure
{
    ...
    {
        [field: Header("Move")]
        [field: SerializeField, Range(1f, 5)] public float MoveChangeFactor { get; private set; }
        [field: SerializeField, Range(0.01f, 100)] public float MoveSmoothing { get; private set; }
    
        [field: Header("Rotatioh")]
        [field: SerializeField, Range(25f, 100f)] public float RotationChangeFactor { get; private set; }
